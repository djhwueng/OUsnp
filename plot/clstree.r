...
plot(ck0tree,edge.width=5,main="k=0",cex.main=5,cex=3)

ck2tree <- vcv2phylo(tree2)
ck2tree$tip.label<-LETTERS[1:size]
plot(ck2tree,edge.width=5,main="k=2",cex.main=5,cex=3)

ck3tree <- vcv2phylo(tree3)
ck3tree$tip.label<-LETTERS[1:size]
plot(ck3tree,edge.width=5,main="k=3",cex.main=5,cex=3)
dev.off()
